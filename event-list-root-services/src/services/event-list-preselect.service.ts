...
export const traceModule = 'gmsSnapins_EventListServices';

@Injectable(
  { providedIn: 'root' }
)
export class EventListPreselectService implements IPreselectionService {

  public typeId = 'EventListType';

  constructor(private readonly traceService: TraceService) {
    this.traceService.info(traceModule, 'EventListPreselectService created');
  }
